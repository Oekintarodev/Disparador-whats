...
export function LoginPage() {
  ...
  const brandingImageUrl = settings?.logoUrl || settings?.iconUrl || '/favicon.png';
  const isFallbackBrandImage = !settings?.logoUrl && !settings?.iconUrl;
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden">
        <div className="flex flex-col lg:flex-row">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #233e4f 0%, #1a2d3b 100%)' }}
          >
            <div className="text-center">
              <div className="w-24 h-24 bg-white/20 rounded-2xl mx-auto mb-8 flex items-center justify-center backdrop-blur-sm">
                <img
                  src={brandingImageUrl}
                  alt={settings?.companyName || settings?.pageTitle || 'Logo do Sistema'}
                  className="w-16 h-16 object-contain"
                  style={isFallbackBrandImage ? { filter: 'brightness(0) invert(1)' } : undefined}
                />
              </div>
              <h1 className="text-4xl font-bold mb-4">{settings?.pageTitle || 'Astra Online'}</h1>
              <p className="text-xl text-gray-100 mb-8">Sistema de Gestao de Campanhas</p>
          ...
          <div className="lg:w-1/2 p-12">
            <div className="max-w-md mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Faca login para acessar sua conta</p>
              </div>
